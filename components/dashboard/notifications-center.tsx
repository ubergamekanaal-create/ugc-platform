...
export function NotificationsCenter({ profile }: NotificationsCenterProps) {
  ...
  return (
    <div ref={panelRef} className="relative">
      ...
      {isOpen ? (
        <div className="absolute right-0 z-40 mt-3 w-[24rem] max-w-[calc(100vw-2rem)] rounded-[1.75rem] border border-slate-200 bg-white p-4 shadow-[0_24px_60px_rgba(15,23,42,0.16)]">
