      ...
      <div className="relative z-10 flex min-h-screen flex-col px-6 py-8 sm:px-8">
        ...
        <PageTransition className="flex flex-1 items-center justify-center">
          <FadeIn className="w-full max-w-[39rem] text-center">
            <div className="mx-auto inline-flex items-center rounded-full border border-slate-200/80 bg-white/80 px-4 py-2 text-xs font-medium uppercase tracking-[0.26em] text-slate-500 shadow-[0_10px_30px_rgba(15,23,42,0.04)] backdrop-blur">
              Brand and creator login
            </div>
