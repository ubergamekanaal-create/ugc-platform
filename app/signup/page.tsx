  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#f6f2ec] text-slate-900">
      ...
      <div className="relative z-10 flex min-h-[100dvh] flex-col px-3 py-3 sm:px-5 sm:py-4">
        ...
        <div className="mx-auto flex w-full max-w-[39rem] flex-1 flex-col justify-center py-8 md:py-6 mt-8 sm:mt-4 border border-slate-200 bg-white p-2 rounded-[1.5rem]">
